...
import sys
import os
import sat_patchy_lib_icosahedron as spl

def generate_cls_file(prefix,crystal_string,Na,Nc,constraint,self_comp=True):
...
ctypes = {'icosahedron': spl.diogo_icosahedron, 'doublediamond': spl.john_doublediamond}

if len(sys.argv) != 6:
    print ('Usage: %s <crystal_type> N_particle_types N_colors prefix/fname patch_constraints')
