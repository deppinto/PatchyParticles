...
diogo_icosahedron='''
Particle 0 patch 0 with Particle 2 patch 2
Particle 0 patch 1 with Particle 8 patch 1
Particle 0 patch 2 with Particle 4 patch 2
Particle 0 patch 3 with Particle 5 patch 0
Particle 0 patch 4 with Particle 9 patch 1
Particle 1 patch 0 with Particle 3 patch 2
Particle 1 patch 1 with Particle 10 patch 0
Particle 1 patch 2 with Particle 6 patch 2
Particle 1 patch 3 with Particle 7 patch 0
Particle 1 patch 4 with Particle 11 patch 2
Particle 2 patch 0 with Particle 6 patch 0
Particle 2 patch 1 with Particle 8 patch 2
Particle 2 patch 3 with Particle 9 patch 0
Particle 2 patch 4 with Particle 7 patch 2
Particle 3 patch 0 with Particle 4 patch 0
Particle 3 patch 1 with Particle 10 patch 1
Particle 3 patch 3 with Particle 11 patch 1
Particle 3 patch 4 with Particle 5 patch 2
Particle 4 patch 1 with Particle 5 patch 1
Particle 4 patch 3 with Particle 8 patch 0
Particle 4 patch 4 with Particle 10 patch 2
Particle 5 patch 3 with Particle 11 patch 0
Particle 5 patch 4 with Particle 9 patch 2
Particle 6 patch 1 with Particle 7 patch 1
Particle 6 patch 3 with Particle 10 patch 4
Particle 6 patch 4 with Particle 8 patch 3
Particle 7 patch 3 with Particle 9 patch 4
Particle 7 patch 4 with Particle 11 patch 3
Particle 8 patch 4 with Particle 10 patch 3
Particle 9 patch 3 with Particle 11 patch 4
'''
...
class LCSS:
    ...
    def __init__(self,Na=None,Nc=None,Np=None,Ns=5,Nr=5, rotations=None):
        ...
        for (p1, s1), (p2, s2) in self.bindings.items():
            for c1 in range(self.Nc):
                for c2 in range(self.Nc):
                    ...
                    #if ss2<0:
                    #    ss2=ss2+self.Ns
                    #constraints.append((-self.F(p1, ss1, c1), -self.F(p2, ss2, c2), -self.B(c1, c2)))
                    #ss1=s1-1
                    #ss2=s2+1
                    #if ss2>=self.Ns:
                    #    ss2=ss2-self.Ns
...
if __name__ == '__main__':
    ...
    ctypes = {'snubcube': diogo_snubcube, 'snubdode': diogo_snubdodecahedron, 'doublediamond': john_doublediamond}
